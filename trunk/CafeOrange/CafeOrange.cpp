...
// CafeOrange.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CCafeOrangeApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CCafeOrangeApp::OnAppAbout)
...
// CCafeOrangeApp construction

CCafeOrangeApp::CCafeOrangeApp()
{
	...
	SetAppID(_T("CafeOrange.AppID.NoVersion"));

	// TODO: add construction code here,
	// Place all significant initialization in InitInstance
}

// The one and only CCafeOrangeApp object

CCafeOrangeApp theApp;


// CCafeOrangeApp initialization
...
int CCafeOrangeApp::ExitInstance()
{
...
// CCafeOrangeApp message handlers
...
void CCafeOrangeApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CCafeOrangeApp customization load/save methods

void CCafeOrangeApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CCafeOrangeApp::LoadCustomState()
{
}

void CCafeOrangeApp::SaveCustomState()
{
}
